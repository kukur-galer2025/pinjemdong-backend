...
<html>
<head>
    <title>Reset Password PinjemDong</title>
    <style>
...
<body>
    <h2>Halo,</h2>
    <p>Kami menerima permintaan untuk mereset kata sandi (password) akun Anda di PinjemDong.</p>
    ...
    <div class="footer">
        <p>Terima kasih,<br>Tim PinjemDong</p>
    </div>
</body>
</html>
